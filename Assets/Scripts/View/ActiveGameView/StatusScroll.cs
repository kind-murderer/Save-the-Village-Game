...
public class StatusScroll
{
    ...
    {
        scroll.text = "You couldn't afford to pay all of the SLAYERS. " + numberLeft + " of them LEFT.";
    ...
    {
        scroll.text = "You can hire new miners or dragon slayers by pressing buttons below";
        scroll.fontStyle = FontStyle.Italic;
        scroll.color = greenColor;
    }
